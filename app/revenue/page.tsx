...
/>
  ...
  {open && (
    <div className="absolute right-0 z-10 mt-2 w-39 rounded-md bg-[#A9C7FF] shadow-lg text-sm text-black ">
      <button className="w-full text-left px-4 py-2 hover:bg-[#377DFF] hover:text-white">Adjust Fees</button>
      <button className="w-full text-left px-4 py-2 hover:bg-[#377DFF] hover:text-white">Download Reports</button>
      <button className="w-full text-left px-4 py-2 hover:bg-[#377DFF] hover:text-white">Set Custom Pricing</button>
       ...
       {/* Shortlisting Fee Settings Details */}
        ...
        <section className="bg-white p-6 rounded-lg shadow-sm">
          <div className="mb-4 flex items-center justify-between">
            <a href="#" className="text-[#1E5EFF] font-medium ">Adjust Fees by Job Type/Location</a>
